...
// FeedbackRecordIDIsNil applies the IsNil predicate on the "feedback_record_id" field.
func FeedbackRecordIDIsNil() predicate.EnrichmentJob {
	return predicate.EnrichmentJob(sql.FieldIsNull(FieldFeedbackRecordID))
}

// FeedbackRecordIDNotNil applies the NotNil predicate on the "feedback_record_id" field.
func FeedbackRecordIDNotNil() predicate.EnrichmentJob {
	return predicate.EnrichmentJob(sql.FieldNotNull(FieldFeedbackRecordID))
}
