...
The `@formbricks/hub-mcp` package lets MCP-capable AI clients work with Formbricks Hub through the generated Hub TypeScript client. AI clients launch it as a local stdio MCP server and point it at either a local Hub instance or a self-hosted production deployment.
