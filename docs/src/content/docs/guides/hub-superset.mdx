...
![Experience Feedback dashboard in Superset showing feedback by source (pie chart), word cloud, NPS funnel, recent feedback table, feedback by type (pie), and total feedback count.](/src/assets/hub-superset-dashboard.png)
...
- [Connecting Hub to Databricks](./hub-databricks) - Same data, with Databricks JDBC or Lakehouse Federation
- [Connecting Hub to Airbyte](./hub-airbyte) - Replicate Hub data into Snowflake, BigQuery, Redshift, or Databricks on a schedule
