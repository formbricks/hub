...
<Callout variant="note">
  ...
  (for example, set `PORT` for Hub and, if needed, a different port for Postgres
  in your `.env` or compose).
</Callout>
...
| --------------------- | ------------------------------------------- | -------------------------------------------------------------------------------- |
| NPS/CSAT over time    | `collected_at`; filter `field_type = nps`   | AVG(value_number) or custom NPS % (see [Superset examples](./superset-examples)) |
...
- [Superset examples](./superset-examples) - More SQL and chart ideas
