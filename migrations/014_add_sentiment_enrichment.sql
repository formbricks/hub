...
-- The CHECKs validate each field's domain (valid label; score in [-2, 2]) and that the two are
-- populated together (both set or both NULL). Their *value* relationship (e.g. "positive" ~ +1,
-- "mixed" ~ 0) is steered by the classifier prompt, not enforced -- a SQL CHECK pinning
